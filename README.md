...
<div align="center">
  ...
  ![CheckNow Logo](https://img.shields.io/badge/CheckNow-v2.8-4CAF50?style=for-the-badge&logo=shield&logoColor=white)
  ...
  *Verificação inteligente de notícias com IA avançada e extração de conteúdo em tempo real*
  ...
  [![Google AI](https://img.shields.io/badge/Google%20Gemini-4285F4?style=for-the-badge&logo=google&logoColor=white)](https://ai.google.dev/)
...
- **Sistema Premium**: Conceito de assinatura com verificações ilimitadas
...
- **Rate Limiting**: Proteção contra uso abusivo das APIs
- **Logs Detalhados**: Sistema completo de monitoramento e debugging
...
- **Context API**: Gerenciamento de estado global reativo
...
- **Error Boundaries**: Tratamento robusto de erros e fallbacks
- **Caching Inteligente**: Otimização de performance e redução de custos
...
- 📰 [GNews](https://gnews.io/) - API de notícias
...
# 🤖 Google Gemini API
EXPO_PUBLIC_GEMINI_API_KEY=sua_chave_api_gemini

# 🔍 Brave Search API
EXPO_PUBLIC_BRAVE_SEARCH_API_KEY=sua_chave_brave_search

# 📰 GNews API
EXPO_PUBLIC_GNEWS_API_KEY=sua_chave_gnews
```

#### 🔑 **Como Obter as Chaves de API**

<details>
<summary><strong>📊 Supabase (Clique para expandir)</strong></summary>

1. Acesse [supabase.com](https://supabase.com/)
2. Crie uma conta e um novo projeto
3. Vá em `Settings` > `API`
4. Copie a `URL` e `anon/public key`
5. Execute as migrações do banco (veja seção de banco de dados)

</details>

<details>
<summary><strong>🤖 Google Gemini (Clique para expandir)</strong></summary>
...
<details>
<summary><strong>🔍 Brave Search (Clique para expandir)</strong></summary>

1. Acesse [Brave Search API](https://search.brave.com/search-api)
2. Crie uma conta e solicite acesso
3. Após aprovação, gere sua chave de API
4. Copie a chave fornecida

</details>

<details>
<summary><strong>📰 GNews (Clique para expandir)</strong></summary>
...
# Conecte ao seu projeto (substitua pelo ID do seu projeto)
...
<details>
<summary><strong>❌ Erro de API Key</strong></summary>

- Verifique se o arquivo `.env` está na raiz do projeto
- Confirme se as chaves estão corretas e ativas
- Reinicie o servidor de desenvolvimento após alterar o `.env`

</details>

<details>
<summary><strong>📱 App não carrega no dispositivo</strong></summary>

- Certifique-se de que o dispositivo está na mesma rede
- Verifique se o firewall não está bloqueando a conexão
- Tente usar o túnel do Expo: `npx expo start --tunnel`

</details>

<details>
<summary><strong>🗄️ Erro de conexão com Supabase</strong></summary>
...
│   ├── 🖼️ images/             # Ícones e imagens
│   └── 🔤 fonts/              # Fontes customizadas
├── 🧩 components/              # Componentes reutilizáveis
│   ├── 📝 VerifyForm.tsx      # Formulário de verificação
│   ├── 📊 VerificationResult.tsx # Resultado da análise
│   ├── 📰 NewsItem.tsx        # Item de notícia
│   ├── 🔔 AdDisplay.tsx       # Sistema de anúncios
│   └── 🎯 FeedbackModal.tsx   # Modal de feedback
├── 🔄 contexts/                # Gerenciamento de estado
│   ├── 🔐 AuthContext.tsx     # Contexto de autenticação
│   ├── ✅ VerificationContext.tsx # Contexto de verificação
│   └── 🎨 ThemeContext.tsx    # Contexto de tema
├── 🎣 hooks/                   # Hooks customizados
│   ├── 🔐 useAuth.ts          # Hook de autenticação
│   └── ✅ useVerification.ts  # Hook de verificação
├── 📚 lib/                     # Serviços e configurações
│   ├── 🗄️ supabase.ts         # Cliente Supabase
│   ├── 🤖 gemini.ts           # Integração Gemini AI
│   ├── 🔍 braveSearch.ts      # API Brave Search
│   ├── 🕷️ webScraper.ts       # Extração de conteúdo web
│   └── 📰 gnews.ts            # API GNews
├── 🗄️ supabase/               # Configurações do banco
│   └── 📊 migrations/         # Migrações SQL
├── 📝 types/                   # Definições TypeScript
│   ├── 📋 index.ts            # Tipos principais
│   └── 🗄️ supabase.ts         # Tipos do Supabase
...
Este projeto foi desenvolvido como TCC, mas está aberto para contribuições da comunidade! Seja você um desenvolvedor experiente ou iniciante, há várias formas de contribuir:
...
- 🧪 **Testes**: Ajude a garantir a qualidade do app

### 📋 **Processo de Contribuição**

1. **🍴 Fork** o repositório
2. **🌿 Crie** uma branch para sua feature (`git checkout -b feature/nova-funcionalidade`)
3. **💻 Desenvolva** sua contribuição seguindo os padrões do projeto
...
- **🎯 Código Limpo**: Siga as convenções do TypeScript e React Native
- **📝 Documentação**: Comente código complexo e atualize a documentação
- **🧪 Testes**: Adicione testes para novas funcionalidades
- **🔒 Segurança**: Nunca commite chaves de API ou dados sensíveis
- **📱 Responsividade**: Garanta compatibilidade com diferentes dispositivos
...
- **DevOps**: CI/CD, Deploy automatizado, Monitoramento
...
### 💝 **Gratidão a todos que tornaram este projeto possível**
...
### 🚀 **CheckNow v2.8 - Verificação Inteligente de Notícias**
...
*"A verdade é o primeiro capítulo do livro da sabedoria."* - Thomas Jefferson

**🛡️ Juntos contra a desinformação! 🛡️**
